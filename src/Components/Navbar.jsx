    ...
    <>
      ...
      >
        ...
        <div className={`flex items-center gap-6`}>
          ...
          <div className={`w-8 h-8  rounded-full lg:border-2 lg:border-orange lg:w-12 lg:h-12 overflow-hidden`}>
            <img src="https://i.pravatar.cc/48?u=110923" alt={crypto.randomUUID()} />
          </div>
        </div>
      </nav>
